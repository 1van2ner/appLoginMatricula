...
<head>
    ...
    <title>Registro - Sistema Matrícula</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-100 flex items-center justify-center min-h-screen">

    <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-md my-10">
        <div class="text-center mb-8">
            <h2 class="text-3xl font-bold text-gray-800">Crear Cuenta</h2>
            <p class="text-gray-500 mt-2">Regístrate para comenzar a usar el sistema</p>
        </div>
        ...
        <div class="mt-6 text-center text-sm">
            <p class="text-gray-600">
                ...
                <a href="{{ route('login') }}" class="text-blue-600 font-medium hover:underline">Inicia sesión aquí</a>
            </p>
        </div>
    </div>
